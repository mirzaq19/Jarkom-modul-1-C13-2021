...
3. Pada web tersebut ada perintah untuk menyebutkan urutan dari pengkabelan `T568A`
...
3. Pada web tersebut ada perintah untuk menyebutkan urutan dari pengkabelan `T568B`
...
4. Paket tersebut dapat tersimpan, tapi untuk meng-_extract_ file didalamnya membutuhkan password
...
4. Dan file `secret.zip` dapat di _extract_ dan tampilan dari isinya sebagai berikut
